...
import { CalendarDays, Sidebar } from "lucide-react";
  ...
  return (
    <div className="flex h-screen bg-[#ffffff] font-sans text-[#1b1c1d] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* 3. Content Area (Calendar + Right Sidebar) */}
        <div className="flex-1 flex overflow-hidden bg-[#fbf9fa]">
          {/* Main Content */}
          {/* Resolvido Problema 4: Aumento do padding-bottom (pb-16) para o calendário não ficar colado */}
          <main className="flex-1 overflow-y-auto p-8 pb-16 flex flex-col">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              {/* Resolvido Problema 1: Filtro Funcional e Botão Removido */}
              {/* Filtro com Botão "TODAS" para limpar a seleção */}
              <div className="flex items-center gap-2 text-[12px] font-bold text-[#74777d] uppercase">
                Filtrar Equipe:
                <div className="flex border border-[#e4e2e3] rounded-[4px] overflow-hidden bg-white ml-2 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                <h2 className="text-[24px] font-bold text-[#1b1c1d]">
              ...
              <div className="flex gap-4 text-[12px] font-medium text-[#44474c] bg-white px-4 py-2 rounded-[6px] border border-[#e4e2e3]">
            ...
            {/* Container do Calendário com margin-bottom extra (Problema 4) */}
          ...
          <aside className="w-[320px] bg-white border-l border-[#e4e2e3] shadow-[-4px_0_24px_rgba(0,0,0,0.02)] z-10 overflow-y-auto">
            <RightSidebarContent />
          </aside>
        </div>
      </div>
